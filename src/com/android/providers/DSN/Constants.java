...
public class Constants {
    ...
    public static final String CLOUD_AUTHORITY = "com.android.providers.decentercloud.documents";
    public static final String CLOUD_ROOT_ID = "Cloud";

    public static final String LOCALDISK_AUTHORITY = "com.android.providers.decenterlocaldisk.documents";
    public static final String LOCALDISK_ROOT_ID = "Local HD";
    /**
