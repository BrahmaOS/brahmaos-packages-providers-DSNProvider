 ...
 * .
 */
public class DSNLocaldiskProvider extends FileSystemProvider {
    private static final String TAG = "DSNCloudProvider";
    private static final boolean DEBUG = false;

    private static final String AUTHORITY = Constants.LOCALDISK_AUTHORITY;
    private static final String DOC_ID_ROOT = Constants.LOCALDISK_ROOT_ID;
    ...
    public Cursor queryRoots(String[] projection) throws FileNotFoundException {
        ...
        row.add(Root.COLUMN_ICON, R.mipmap.ic_laucher_dsnlocal);
        row.add(Root.COLUMN_TITLE, getContext().getString(R.string.root_localdisk));
    ...
    */
    ...
    public void deleteDocument(String docId) throws FileNotFoundException {
        // Delegate to real provider
        Log.d("XULU_LOG","DecenterCloudProvider deleteDocument:" + docId);
        final long token = Binder.clearCallingIdentity();
        try {
            if (RawDocumentsHelper.isRawDocId(docId)) {
                Log.d("XULU_LOG","DecenterCloudProvider deleteDocument 1 :" + docId);
                super.deleteDocument(docId);
                return;
            }
            Log.d("XULU_LOG","DecenterCloudProvider deleteDocument 2 :" + docId);
...
*/
    ...
    private static File getDownloadsDirectory() {
        return Environment.getExternalStoragePublicDirectory("LocalHD");
    }
